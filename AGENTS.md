...
In the 'product' page, Consultation Notes section, the doctor will provide the notes of the patient's visit that includes what was examined and any prescriptions. There is a 'Specialty' dropdown selection box that provides a medical specialty, i.e. General Practice, Pulmonology, etc.  
